...
class Paciente
{
     ...
     *
     *
     * @ORM\ManyToOne(targetEntity="TipoParto" inversedBy="paciente")
     * @ORM\JoinColumns({
     ...
     * @var \TipoSanguineo
     *
     * @ORM\ManyToOne(targetEntity="TipoSanguineo" inversedBy="paciente")
     * @ORM\JoinColumns({
     ...
     *
     * @ORM\OneToMany(targetEntity="Paciente_Cuidado", mappedBy="paciente")
     * @ORM\JoinColumn(name="ncuidados_id", referencedColumnName="id")
     */
    private $nCuidados;
   ...
   /**
     * @var \Doctrine\Common\Collections\Collection
    *
     * @ORM\OneToMany(targetEntity="Paciente_ProblemasSaude", mappedBy="paciente")
    *   @ORM\JoinColumn(name="pacienteproblemasSaude_id", referencedColumnName="id")
     ...
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\OneToMany(targetEntity="Orden_Responsavel", mappedBy="paciente" )
    ...
    {
        $this->paciente_problemasSaude->removeElement($p_problemassaude);
        if ($this->paciente_problemasSaude->contains($p_problemassaude)) {
            $this->paciente_problemasSaude->removeElement($p_problemassaude);
