...
class Paciente
{
     ...
     * @var \TipoSanguineo
     *
     * @ORM\ManyToOne(targetEntity="TipoSanguineo", inversedBy="paciente",cascade={"persist", "remove"})
     * @ORM\JoinColumns({
    ...
    *   @ORM\JoinColumn(name="pacienteproblemasSaude_id", referencedColumnName="id")
    ...
    /**
     * Add Paciente_Cuidado
     *
     * @param \EntityBundle\Entity\Cuidados $nCuidados
     * @return Paciente
     */
    public function addPacienteCuidados(\EntityBundle\Entity\Paciente_Cuidado $nCuidados = null)
    {
        if (!$this->pacienteCuidados->contains($nCuidados) && $nCuidados != null) {
