 ...
 */
class Usuario extends \EntityBundle\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EntityBundle\\Entity\\Usuario' . "\0" . 'id', '' . "\0" . 'EntityBundle\\Entity\\Usuario' . "\0" . 'nombre', '' . "\0" . 'EntityBundle\\Entity\\Usuario' . "\0" . 'username', '' . "\0" . 'EntityBundle\\Entity\\Usuario' . "\0" . 'password', '' . "\0" . 'EntityBundle\\Entity\\Usuario' . "\0" . 'rol', '' . "\0" . 'EntityBundle\\Entity\\Usuario' . "\0" . 'salt');
        }
