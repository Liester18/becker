...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/r')) {
            ...
            // reports_ajax
            if (rtrim($pathinfo, '/') === '/r/ajaxfilter') {
                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'reports_ajax');
                }

                return array (  '_controller' => 'ReportsBundle\\Controller\\DefaultController::filterAction',  '_route' => 'reports_ajax',);
            }

            // reports_page
            if (preg_match('#^/r/(?P<actualPage>[^/]++)$#s', $pathinfo, $matches)) {
            ...
            // reports_list
            if (rtrim($pathinfo, '/') === '/r/list') {
                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'reports_list');
                }

                return array (  '_controller' => 'ReportsBundle\\Controller\\DefaultController::exportAction',  '_route' => 'reports_list',);
            }
